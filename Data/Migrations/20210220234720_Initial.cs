        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    status = table.Column<string>(type: "text", nullable: true, defaultValue: ""),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    content = table.Column<string>(type: "text", nullable: true, defaultValue: ""),
                    excerpt = table.Column<string>(type: "text", nullable: true, defaultValue: ""),
                    updated_date = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "now()"),
                    created_date = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "now()"),
                    author = table.Column<Guid>(type: "uuid", nullable: false),
                    status = table.Column<string>(type: "text", nullable: true, defaultValue: "draft"),
                    type = table.Column<string>(type: "text", nullable: true, defaultValue: "post")
                },
                constraints: table =>
                {
